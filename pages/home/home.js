  ...
  data: {
    ...
    result:{
      ...
      sz:[
        {
          id: 1004,
          imgsrc: '/pages/imgs/bao.png',
          title: '本人在2019年1月1日在哈尔滨工业大学图书馆捡到钱包一个',
          category: '包',
          time: '2019-01-12',
          address: '哈尔滨市-南岗区',
          detail: '本人在2019年1月1日下午在哈尔滨工业大学图书馆自习室捡到黑色女士皮包一个,里面有现金若干,身份证,银行卡若干,如果失主看见此条消息可以联系我活着图书管管理员, QQ1611756998或者微信 18746092678'
        }
      ]
    }
  },
